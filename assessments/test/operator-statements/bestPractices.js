...
describe('best practices', function () {
    it.skip('you should avoid global variables', function (next) {
        bestPracticesAnswers.globals();
        expect(moduleScope.myObject).not.to.be.ok;
        next();
    });

    it.skip('you should use parseInt correctly', function (next) {
    ...
    it.skip('you should understand strict comparison', function (next) {
