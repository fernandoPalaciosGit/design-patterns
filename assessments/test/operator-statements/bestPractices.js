...
describe('best practices', function () {
    it.skip('should avoid global variables', function (next) {
        bestPracticesAnswers.globals();
        expect(moduleScope.myObject).not.to.be.ok;
        next();
    });

    it.skip('should use parseInt correctly', function (next) {
    ...
    it.skip('should understand strict comparison', function (next) {
