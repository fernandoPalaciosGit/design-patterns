...
describe('regular expressions', function () {
    ...
    it.skip('you should be able to detect a repeating letter in a string', function () {
    ...
    it.skip('you should be able to determine whether a string ends with a vowel (aeiou)', function () {
    ...
    it.skip('you should be able to capture the first series of three numbers', function () {
    ...
    it.skip('you should be able to determine whether a string matches a pattern', function () {
    ...
    it.skip('you should be able to detect correctly-formatted monetary amounts in USD', function () {
