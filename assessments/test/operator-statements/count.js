...
describe('counter', function () {
    ...
    it.skip('should count from start number to end number, one per 1/10th of a second', function () {
        this.timeout(600);
    ...
    it.skip('should provide a method to cancel the counting', function () {
        this.timeout(600);
