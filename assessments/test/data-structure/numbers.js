...
describe('numbers', function () {
    describe('binary operations', function () {
        it.skip('should be able to find the value of a given bit', function (next) {
        ...
        it.skip('should be able to return the base10 representation of a binary string', function (next) {
            expect(numbersAnswers.base10('11000000')).to.eql(192);
            next();
        });

        it.skip('should be able to convert an eight-bit number to a binary string', function (next) {
    ...
    describe('decimals', function () {
        it.skip('should be able to multiply with precision', function (next) {
