...
describe('numbers', function () {
    describe('binary operations', function () {
        ...
        it.skip('you should be able to return the base10 representation of a binary string', function () {
            expect(numbersAnswers.base10('11000000')).to.eql(192);
        });

        it.skip('you should be able to convert an eight-bit number to a binary string', function () {
    ...
    describe('decimals', function () {
        it.skip('you should be able to multiply with precision', function () {
